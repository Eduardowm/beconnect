                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="has-float-label" aria-label="Mensagem">
                            <input class="form-control" type="text" placeholder="Mensagem" name="mensagem"/>
                            <span>Mensagem</span>
                        </label>
                    </div>

                    <button class="btn btn-outline-primary float-right btn-submit mt-5">enviar mensagem</button>
                </div>
            </div>
        </div>
    </div>
